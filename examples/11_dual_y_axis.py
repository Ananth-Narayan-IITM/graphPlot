...
Demonstrates:
    ...
    - common X-axis
    - grouped/table-style common legend
...
This is useful when different physical quantities share
the same X-axis but have different Y-axis scales.
"""
...
ax_left.set_title("Multiple datasets with dual Y-axes")
